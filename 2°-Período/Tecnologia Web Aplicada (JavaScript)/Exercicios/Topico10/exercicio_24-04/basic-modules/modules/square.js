...
export { name, draw, reportArea, reportPerimeter, randomSquare };    // Exporta tudo de uma vez
export default Square;           // Define o comportamento padrão, fazendo com que possa renomear o metodo sem dar erro
